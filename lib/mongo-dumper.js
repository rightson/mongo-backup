...
Dumping ${key}...`);
    ...
    async run() {
        try {
            ...
            console.log('Analyzing collection size for progress estimation...');
            const totalDocs = await this.coll.countDocuments({});
            console.log(`✓ Found ${totalDocs.toLocaleString()} total documents.`);
